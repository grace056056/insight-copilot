        ...
        <div className="brand">
          <span className="logo">
            <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
              ...
              <circle cx="11.5" cy="8" r="2.2" fill="url(#nav-tg)" />
              <circle cx="8.4" cy="8" r="0.9" fill="#fff" />
              <defs>
                <radialGradient id="nav-tg" cx="0.35" cy="0.35" r="0.9">
...
.flp .brand{display:flex;align-items:center;gap:10px;font-weight:600;font-size:14px;letter-spacing:-.01em;white-space:nowrap;color:#dce5f5;font-family:'Bricolage Grotesque',sans-serif}
.flp .brand .sec2{color:#8195b3}
.flp .logo{width:28px;height:28px;border-radius:8px;background:linear-gradient(135deg,#141b33,#0c1223);border:1px solid #263455;display:flex;align-items:center;justify-content:center;flex-shrink:0}
...
.flp .footer{position:relative;z-index:1;border-top:1px solid rgba(26,36,64,.6);padding:18px 0;margin-top:40px;text-align:center;font-size:11px;color:#56688a}
